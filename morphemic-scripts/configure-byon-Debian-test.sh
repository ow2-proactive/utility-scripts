...
AGENTURL="https://proactive-node-agent.s3.eu-west-3.amazonaws.com/activeeon_enterprise-node-linux-x64-12.1.0-SNAPSHOT.zip"
AGENTFILE="activeeon_enterprise-node-linux-x64-12.1.0-SNAPSHOT"
AGENTDIR="/opt"
