...
AGENTURL="https://website-software-ae.s3.eu-central-1.amazonaws.com/activeeon_enterprise-node-linux-x64-13.0.0.zip"
AGENTFILE="activeeon_enterprise-node-linux-x64-13.0.0"
AGENTDIR="/opt"
